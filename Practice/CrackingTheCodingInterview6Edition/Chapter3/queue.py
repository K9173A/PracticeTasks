"""
Простейший вариант реализации очереди (односвязной и двусвязной) поверх
обычного списка. Реализовывать Queue нет целесообразности, потому что имеется
отдельный модуль с потокобезопасной версией Queue. Реализация исключительно
для практики.
"""
